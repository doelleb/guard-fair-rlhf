...
SAVE_DIR = "/workspace/full_hhrlhf_results"
...
if __name__ == "__main__":
    ...
    tokenizer.save_pretrained(os.path.join(SAVE_DIR, "model_checkpoint"))
    ...
    plt.savefig(os.path.join(SAVE_DIR, "chosen_vs_rejected.png"))
    plt.close()
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(os.path.join(SAVE_DIR, "helpful_vs_harmless.png"))
    plt.close()
